...
} from "jsr:@cliffy/flags@1.1.0";
import { bold, brightBlue, red } from "jsr:/@std/fmt@^1.0.9/colors";
import type {
  IsRequired,
  MapTypes,
  MapValue,
...
import { exit } from "jsr:@cliffy/internal@1.1.0/runtime/exit";
import { getArgs } from "jsr:@cliffy/internal@1.1.0/runtime/get-args";
import { getEnv } from "jsr:@cliffy/internal@1.1.0/runtime/get-env";
import type {
  Merge,
  Mutable,
  OneOf,
...
import type { ArgumentOptions } from "jsr:@cliffy/flags@1.1.0";
